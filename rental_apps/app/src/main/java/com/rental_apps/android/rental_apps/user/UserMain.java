...
import com.rental_apps.android.rental_apps.Main2Activity;
import com.rental_apps.android.rental_apps.R;
import com.rental_apps.android.rental_apps.Rating;
...
//        adminListUser=new AdminListUser();
        ...
        mHelpLiveo.add("Maps", R.drawable.ic_location);
        ...
        with(this).startingPosition(0)
                ...
                //.footerItem(getString(R.string.maps), R.drawable.ic_location)
    ...
    public void onItemClick(int position) {
        ...
        switch (position){
            ...
            case 2:
                move.moveActivity(mContext, Main2Activity.class);
                break;
            case 3:
              //  move.moveActivity(mContext, Rating.class);
                break;
            case 4:
